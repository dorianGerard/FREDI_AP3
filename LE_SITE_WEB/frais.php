...
<body>
    <table class="UserList">
        <tr class="UserList">
            ...
            foreach($row as $rows)
            {
                echo "<tr class='UserList'><td class='UserList2'>".$rows['id_note']."</td><td class='UserList2'>".$rows['est_valide']."</td><td class='UserList2'>".$rows['mt_total']." €</td><td class='UserList2'>".$rows['dat_remise']."</td><td class='UserList2'>".$rows['nr_ordre']."</td></tr>";
            }
            ?>
    </table>
