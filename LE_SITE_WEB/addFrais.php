...
try {
    echo "INSERT INTO ligne(date_ligne, lib_trajet, nb_km, mt_km, mt_peage, mt_repas, mt_hebergement, mt_total, id_motif, id_note) VALUES (".$date.", ".$trajet.", ".$km.", ".$mt_km.", ".$peage.", ".$repas.", ".$hebergement.", ".$mt_total.", ".$motif.", ".$row['id_note'].")\n";
